...
import setipTransportsRoutes from "./routes/setipTransports";
import seppertLockersRoutes from "./routes/seppertLockers";
import feedbacksRoutes from "./routes/feedbacks";
import meetingsRoutes from "./routes/meetings";
import ombudsmanRoutes from "./routes/ombudsman";
...
app.use("/api/setip/transports", setipTransportsRoutes);
app.use("/api/seppert/lockers", seppertLockersRoutes);
app.use("/api/suac/feedbacks", feedbacksRoutes);
app.use("/api/suac/meetings", meetingsRoutes);
app.use("/api/suac/ombudsman", ombudsmanRoutes);
app.use("/api/suac/overtime", overtimeRoutes);
